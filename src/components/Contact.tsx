    ...
    <div id="contact" className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 flex justify-center space-x-6">
          <a href="https://bxqmx9wxv2m.feishu.cn/wiki/HgR0wCHO9ifbaVkWZ2UcLPwknTb?from=from_copylink" className="text-gray-400 hover:text-gray-600 transition-colors duration-300">
